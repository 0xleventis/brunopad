...
interface IBrunoHook {
    ...
    // note: original base IBrunoHook deployment is missing these functions but
    // the IBrunoLpFeeConversion locker needs them
